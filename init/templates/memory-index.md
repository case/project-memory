...
## Core
- [Product](product.md) — what ${name} is and why; implementation-independent
- [Architecture](architecture.md) — current implementation: stack, layout, conventions

## Log (newest first)
- [${today} Bootstrap memory system](log/${today}-bootstrap.md) — initial setup of this memory system
